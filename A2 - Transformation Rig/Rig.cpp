...
{
	// Set position and scale of root bone
	// AKA the chest
	m_pRoot->SetPosition(0.0f, 1.0f, 0.0f);
	m_pRoot->SetScale(2.0f, 1.0f, 1.0f);

	// Torso
	Bone* torsoBone = new Bone();
	torsoBone->SetParent(m_pRoot);
	torsoBone->SetPosition(0.0f, -1.0f, 0.0f);
	torsoBone->SetScale(1.25f, 1.0f, 1.0f);

	// Neck
	Bone* neckBone = new Bone();
	neckBone->SetParent(m_pRoot);
	neckBone->SetPosition(0.0f, 5.0f, 0.0f);
	...
	leftA1Bone->SetParent(m_pRoot);
	leftA1Bone->SetPosition(-3.0f, 2.0f, 0.0f);
	leftA1Bone->SetScale(1.0f, 0.5f, 1.0f);

	// Left Arm 2
	Bone* leftA2Bone = new Bone();
	leftA2Bone->SetParent(leftA1Bone);
	leftA2Bone->SetPosition(-5.0f, 2.0f, 0.0f);
